...
checkpoint_filepath = '/home/jin-holee/LSTM_logback'
...
X_train = np.load('/home/jin-holee/X_train.npy')
y_train = np.load('/home/jin-holee/y_train.npy')

X_test = np.load('/home/jin-holee/X_test.npy')
y_test = np.load('/home/jin-holee/y_test.npy')
...
#save model
print(f'Saving model in saved_model/{model_name}')
