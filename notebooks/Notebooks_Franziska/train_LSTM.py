...
checkpoint_filepath = '/home/franzi/LSTM_logback'
...
model.summary()
training_history = model.fit(X_train, y_train, validation_split=0.2 ,epochs=500, verbose=1, callbacks=[cp_callback])
