...
checkpoint_filepath = './LSTM_logback/best_model_weights.h5'
...
X = np.load('./X_20_z.npy')
y = np.load('./y_20_z.npy')
...
model_name = 'LSTM_model_20signsz_8'
...
model.add(Dense(20, activation='softmax')) # 250 as output, due to 250 signs
